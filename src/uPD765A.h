...
public:
  ...
  // callbacks
  typedef void (* shiftOutDataCallback)( void * context, int address );

  void setCallbacks( void * context, shiftOutDataCallback shiftOutData )
  {
    m_context      = context;
    m_shiftOutData = shiftOutData;
  }
  ...
  uint8_t getMaintatus( void )              { return m_mainStatus; }
...
private:
  ...
  shiftOutDataCallback  m_shiftOutData;   // callback : shiftOutData()
